...
class BlogApiControllerTest {
    ...
    // 직렬화: 자바 객체를 json 데이터로 변환 ( json-http / java-객체 )
    ...
    public void addArticle() throws Exception {
        ...
        ResultActions result = mockMvc.perform(post(url)
                .contentType(MediaType.APPLICATION_JSON_VALUE) // json, xml 등 중에 요청 보낼 타입 선택
                .content(requestBody));
        ...
        assertThat(articles.size()).isEqualTo(1); // 크기(블로그 글의 개수)가 1인지 검증
